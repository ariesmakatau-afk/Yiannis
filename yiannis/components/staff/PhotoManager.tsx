...
export default function PhotoManager({ initialUrl }: { initialUrl: string | null }) {
    ...
    <div className="min-h-screen bg-mist">
      ...
      <main className="container-page max-w-xl py-8">
        ...
        <p className="mt-5 text-xs leading-relaxed text-ink/45">
          JPG, PNG or WEBP, up to 8MB. Landscape photos look best. Get everyone&rsquo;s
          okay before putting their face on the site.
        </p>
      </main>
    </div>
  );
