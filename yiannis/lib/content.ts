...
export const business = {
  ...
  history: "Trading for around 30 years in Adelaide CBD.",
  address: {
...
export const heroCopy = {
  headline: "Greek Yiros in the Heart of Adelaide CBD",
  subheading:
    "Freshly made yiros, loaded plates, crispy chips and authentic Greek flavours on Hindley Street — serving Adelaide for over 30 years.",
};

export const locationIdentifier = {
  line1: "Looking for Yianni's on Hindley Street? You've found us.",
  line2: `${fullAddress} — Adelaide CBD`,
};

export const aboutCopy = {
  eyebrow: "Greek Food. Adelaide CBD. Done Properly.",
  body: "For around 30 years, Yianni's on Hindley Street has been serving up authentic Greek-style yiros, loaded plates and generous packs from the heart of Adelaide's CBD. Fresh ingredients, real recipes, and a bit of Spartan pride — this is the original Hindley Street experience.",
};

export const whyYiannis = [
  { title: "Freshly prepared", detail: "Made to order, every time." },
  { title: "Greek flavours", detail: "Real recipes, not shortcuts." },
  { title: "Generous portions", detail: "No one leaves hungry." },
  { title: "Adelaide CBD location", detail: "Right on Hindley Street." },
  { title: "30 years serving Adelaide", detail: "A CBD institution since day one." },
];
...
export const siteMeta = {
  titleDefault: "Yianni's on Hindley Street | Greek Yiros Adelaide CBD",
  description:
    "Yianni's on Hindley Street serves Greek yiros, plates, chips and more in Adelaide CBD. Visit us at 270 Hindley Street or order online.",
};
