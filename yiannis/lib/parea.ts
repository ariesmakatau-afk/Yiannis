...
export const pareaIntro = {
  ...
  meaning:
    "The people you eat with. Not guests, not customers — the company you keep. Greek has one word for it because it matters that much.",
...
export const promo = {
  ...
  strip: "Free small chips with any yiros — Tuesdays only.",
  eyebrow: "Quiet days, loud plates",
  title: "Free Chips Tuesdays",
  body: "Order any yiros on a Tuesday and the small chips are on us. No code, no catch — it's just quieter on Tuesdays, and chips are better shared.",
  finePrint: "Dine-in and takeaway. One per order. Tuesdays only.",
};
