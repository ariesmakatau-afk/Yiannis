    ...
    <>
      ...
      <section className="bg-sand py-16 sm:py-20">
        <div className="container-page">
          ...
          {pareaPhotos.length > 0 ? (
            <div className="mt-9 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {pareaPhotos.map((photo) => (
                <figure key={photo.src} className="plinth overflow-hidden rounded-sm bg-white">
                  <Image
                    src={photo.src}
      ...
      {/* THE OFFER */}
      {promo.active && (
        <section className="scene-atmosphere scene-atmosphere-dark relative bg-cobalt-dark py-16 text-white sm:py-20">
