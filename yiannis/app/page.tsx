...
const featuredFood = [
  {
    label: "Yiros",
    blurb: "Lamb, chicken, pork or combo, built fresh.",
    image: "/images/food-yiros.jpg",
  },
  {
    label: "Platters & Packs",
    blurb: "Generous, shareable, dine-in or take away.",
    image: "/images/food-platters.jpg",
  },
  {
    label: "Chips & Sides",
    blurb: "Crispy, golden, family-size if you're hungry.",
    image: "/images/food-chips.jpg",
  },
  {
    label: "Drinks",
    blurb: "Including a proper Greek coffee.",
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-3">
            {featuredReviews.map((review) => (
              <div key={review.author} className="carved-panel flex flex-col p-6">
                <div className="text-sm tracking-wide text-cobalt" aria-label="5 out of 5 stars">
                  ★★★★★
                </div>
