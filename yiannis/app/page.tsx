  ...
  return (
    <>
      ...
      {promo.active && (
        <Link
          href="/parea"
          className="group block bg-brass text-cobalt-dark transition-colors hover:bg-brass-light"
        >
          <div className="container-page flex items-center justify-center gap-2.5 py-2.5 text-center">
            <span className="text-sm font-bold uppercase tracking-wide">
              {promo.title}
            </span>
            <span aria-hidden="true" className="opacity-40">/</span>
            <span className="text-sm font-medium">{promo.strip}</span>
            <span
              aria-hidden="true"
      ...
      {/* FINAL CTA */}
      <section className="scene-atmosphere scene-atmosphere-dark relative overflow-hidden bg-cobalt py-16 text-center text-white sm:py-24">
