...
export default function LocationPage() {
  return (
    <div className="container-page py-10 sm:py-14">
      <h1 className="font-display text-3xl font-semibold sm:text-4xl">Location</h1>
      <div className="meander-divider-navy mt-4 w-24 opacity-70" aria-hidden="true" />
      <LocationIdentifier className="mt-6" />

      <div className="mt-10 grid gap-10 lg:grid-cols-2">
        <div
          className="flex min-h-[320px] items-center justify-center border border-dashed border-ink/25 bg-ink/[0.04] text-center text-sm text-ink/50"
          role="img"
        ...
        <div>
          ...
          <p className="mt-2 text-ink/70">{fullAddress}</p>

          <h2 className="mt-8 font-display text-xl font-semibold">Opening Hours</h2>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link href="/order" className="btn-outline-dark">
              Order Online
            </Link>
          </div>
        </div>
