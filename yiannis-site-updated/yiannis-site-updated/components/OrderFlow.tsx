...
export default function OrderFlow() {
    ...
    return (
      <div className="grid gap-4 sm:grid-cols-2">
        <a
          ...
          className="flex flex-col justify-between border border-ink/15 bg-white p-6 transition-colors hover:border-cobalt"
        >
          <div>
        ...
        <button
          ...
          className="flex flex-col justify-between border border-ink/15 bg-white p-6 text-left transition-colors hover:border-cobalt"
        >
          <div>
  ...
  if (step === "sent") {
    return (
      <div className="border border-ink/15 bg-white p-8 text-center">
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
      ...
      {/* Cart summary */}
      <aside className="h-fit border border-ink/15 bg-white p-5 lg:sticky lg:top-24">
